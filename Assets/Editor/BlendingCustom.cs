...
{
    internal class BlendingCustom : ShaderGUI
    {
        ...
        private static class Styles
        {
            ...
            public static GUIContent blendValueText = new GUIContent("Blend Value", "");
            public static GUIContent blendTextureText = new GUIContent("Blend Mask", "Blend mask used to blend in");
        ...
        MaterialProperty blendValue = null;
        ...
        public void FindProperties(MaterialProperty[] props)
        {
            ...
            blendValue = FindProperty("_BlendValue", props);
            ...
            blendMask = FindProperty("_BlendTex", props);
        ...
        public void ShaderPropertiesGUI(Material material)
        {
            ...
            EditorGUI.BeginChangeCheck();
            {
                ...
                m_MaterialEditor.TexturePropertySingleLine(Styles.blendTextureText, blendMask, blendValue);
                EditorGUI.BeginChangeCheck();
